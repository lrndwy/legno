...
SECRET_KEY = 'django-insecure-z7(xb=mho49+f#p$o6(y&lom=53zcdvqi54f@ff3)zja(=9e37'
...
JAZZMIN_SETTINGS = {
    ...
    "welcome_sign": "Legno Tropicalindo",
    ...
    "order_with_respect_to": ["managemen","auth"],
    ...
    "changeform_format_overrides": {"auth.user": "horizontal_tabs"},
}
